...
from model.train_clipcap import MappingType, ClipCaptionModel
...
class ClipCapVQAModel(ClipCaptionModel):
    ...
    def forward(self, prefix: torch.Tensor, tokens: torch.Tensor):
        ...
        # out_1 = self.gpt.transformer.drop(e)
        # for i in range(12):
        #     if i==0:
        #         out_1 = self.gpt.transformer.h[i](e)
        #     else:
        #         out_1 = self.gpt.transformer.h[i](out_1[0])
        out_1 = self.gpt.transformer(inputs_embeds = e)
        out_1 = self.gpt.lm_head(out_1[0])
        return out
